...
Данная программа предназначена для работы с мемристорами и мемристорными кроссбарами с использованием различных измерительных архитектур (к примеру, плат MemArdBoard и MemRaspBoard). В программе заложен функционал проведения измерений и снятия различных характеристик мемристоров, автоматического тестирования, использования мемристоров в качестве памяти ReRAM, выполнения математических операций и работы с искусственными нейронными сетями. В программе также есть симулятор мемристоров, поэтому с ней можно работать и не имея оборудования.

![Общий вид программы](docs/assets_rus/general.png)
...
Инструкция по работе с программой приведена [в папке `/docs`](https://github.com/neurocomputer/MemBoard/blob/main/docs/README_rus.md).
...
## Собранные .exe файлы для пользователей Windows
