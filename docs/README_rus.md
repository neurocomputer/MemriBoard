...
![Окно подключения с развернутым созданием кроссбара](assets-rus/add_crossbar.png)
...
###### Окно настроек:
![Окно настроек](assets-rus/settings.png)
...
![Ячейка кроссбара](assets-rus/crossbar_cell.png)
...
- ###### "История" 
    ...
    ![Окно истории ячейки](assets-rus/history.png)
...
![Окно редактирования сигнала](assets-rus/new_exp.png)
...
![Окно настройки сигнала](assets-rus/signal.png)
...
![Окно проведения эксперимента](assets-rus/apply.png)
</p>
